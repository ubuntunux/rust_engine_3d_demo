...
use crate::renderer::project_renderer::{ ProjectRenderer, RenderMode, RenderObjectType };
...
pub fn get_framebuffer_data_create_info(project_renderer: &ProjectRenderer) -> FramebufferDataCreateInfo {
    framebuffer::create_framebuffer_data_create_info(
        &[],
        &[RenderTargetInfo {
            _texture_data: project_renderer.get_render_target(RenderTargetType::Shadow),
            _target_layer: 0,
            _target_mip_level: 0,
