...
pub fn get_framebuffer_data_create_info(project_renderer: &ProjectRenderer) -> FramebufferDataCreateInfo {
    let swapchain_data = project_renderer.get_renderer_data().get_swap_chain_data();
...
pub fn get_render_pass_data_create_info(project_renderer: &ProjectRenderer) -> RenderPassDataCreateInfo {
    let render_pass_name = String::from("render_ui");
    ...
    let pipeline_data_create_infos = vec![
        PipelineDataCreateInfo {
            _pipeline_data_create_info_name: String::from("render_ui"),
            _pipeline_vertex_shader_file: PathBuf::from("render_ui.vert"),
            _pipeline_fragment_shader_file: PathBuf::from("render_ui.frag"),
            ...
            _push_constant_ranges: vec![vk::PushConstantRange {
                ...
                offset: 0,
                size: std::mem::size_of::<PushConstant_RenderUI>() as u32,
            }],
            _descriptor_data_create_infos: vec![
                ...
                DescriptorDataCreateInfo {
                    ...
                    _descriptor_name: String::from("texture_normal"),
                    _descriptor_resource_type: DescriptorResourceType::Texture,
                    _descriptor_shader_stage: vk::ShaderStageFlags::VERTEX | vk::ShaderStageFlags::FRAGMENT,
                    ..Default::default()
                },
