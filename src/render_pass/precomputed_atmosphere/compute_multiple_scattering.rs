...
pub fn get_render_pass_data_create_info(project_renderer: &ProjectRenderer) -> RenderPassDataCreateInfo {
    ...
    let pipeline_data_create_infos = vec![PipelineDataCreateInfo {
        ...
        _pipeline_fragment_shader_file: PathBuf::from("precomputed_atmosphere/compute_multiple_scattering.frag"),
        ...
        _descriptor_data_create_infos: vec![
            ...
            DescriptorDataCreateInfo {
                ...
                _descriptor_name: enum_to_string(&RenderTargetType::PRECOMPUTED_ATMOSPHERE_DELTA_SCATTERING_DENSITY),
                _descriptor_resource_type: DescriptorResourceType::RenderTarget,
                _descriptor_shader_stage: vk::ShaderStageFlags::FRAGMENT,
                ..Default::default()
            },
