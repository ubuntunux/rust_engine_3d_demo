...
pub fn get_framebuffer_data_create_info(project_renderer: &ProjectRenderer) -> FramebufferDataCreateInfo {
    let render_target0 = project_renderer.get_render_target(RenderTargetType::PRECOMPUTED_ATMOSPHERE);
    let render_target1 = project_renderer.get_render_target(RenderTargetType::PRECOMPUTED_ATMOSPHERE_INSCATTER);
    ...
    let pipeline_data_create_infos = vec![
        PipelineDataCreateInfo {
            ...
            _push_constant_ranges: vec![vk::PushConstantRange {
                ...
                offset: 0,
                size: std::mem::size_of::<PushConstant_Atmosphere>() as u32,
            }],
